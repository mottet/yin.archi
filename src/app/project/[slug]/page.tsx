...
const projects: Record<string, ProjectPageProps> = {
    "centre-culturel-ceramistes": {
        ...
        imagesFolder: "/DAI 5",
        images: [
            { name: "image 1_CShading_LightMix", width: 1152, height: 658 },
            { name: "image 2_CShading_LightMix", width: 1152, height: 658 },
            { name: "image 3_CShading_LightMix", width: 1152, height: 658 },
            { name: "image 4_CShading_LightMix", width: 1152, height: 658 },
            { name: "image 6 _with lighting _CShading_LightMix", width: 1152, height: 864 },
            ...
            { name: "PLAN _atelier et residence RDC_50e", width: 1152, height: 466 },
            { name: "PLAN _atelier et residence R+1_50e", width: 1152, height: 248 },
            { name: "Résidence Atelier Coupe AA 50e", width: 1152, height: 358 },
            { name: "Résidence Atelier Coupe AA 50e bis", width: 1152, height: 358 },
            { name: "Résidence Coupe BB 50e_frist try", width: 1152, height: 815 },
            { name: "Résidence Coupe CC 50e", width: 1152, height: 815 },
            { name: "PLANS _salon de thé+COUPE AA_50e", width: 1000, height: 1414 },
            { name: "salon de thé COUPE BB_50e", width: 1152, height: 479 },
            { name: "CONCEPT entre les deux espace_rapprocher la nature_parte 1", width: 1152, height: 480 },
            { name: "CONCEPT entre les deux espace_rapprocher la nature_parte 2", width: 1152, height: 480 }
        ]
    },
    "fablab-info-elec": {
        ...
        imagesFolder: "/DAI 3",
        images: [
            { name: "Extérior_vue de bâtiment du pont", width: 1152, height: 864 },
            { name: "Extérior_vue sous le passage courbe de l_auvent", width: 1152, height: 864 },
            { name: "Extérior_vue sur la quai de la Marne", width: 1152, height: 864 },
            { name: "Interior 1_co-working space", width: 1152, height: 864 },
            { name: "Interior 2_espace d_entrée", width: 1152, height: 864 },
            { name: "Interior 4_cube 2", width: 1152, height: 864 },
            { name: "Interior 5_connect to the gym", width: 1152, height: 864 },
            { name: "Interior 7_R+1 going through", width: 1152, height: 864 },
            { name: "plan de situation_meter-A2_", width: 1152, height: 836 },
            { name: "Rough_on the bridge", width: 1152, height: 823 },
            { name: "Rough_reception", width: 1152, height: 829 },
            { name: "Rough_under the bridge", width: 1152, height: 970 },
            { name: "ZOOM plan_A1-R+1_50e_couleur", width: 1152, height: 646 }
        ]
    },
    "ecole-archi-st-lazard": {
        ...
        imagesFolder: "/DAI 4",
        images: [
            { name: "01_Entrée_vue de micro d_architecture", width: 1152, height: 740 },
            { name: "02_center point where connect different volumes", width: 1152, height: 740 },
            { name: "03_RDC_vue vers le grand panneau", width: 1152, height: 740 },
            { name: "04_R+1_vue vers la salles de cours", width: 1152, height: 740 },
            { name: "05_R+1_from one end to the other toward the tympan", width: 1152, height: 740 },
            { name: "06_vue vers le tympan", width: 1152, height: 740 },
            { name: "1200px-Genie_civil_1886_A6_T9_N13_P194_messageries_saint_lazare", width: 1152, height: 580 },
            { name: "1280px-Genie_civil_1886_A6_T9_N13_P193_messageries_saint_lazare", width: 1152, height: 867 },
